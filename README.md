...
- `data.csv`: Sample or synthetic dataset.
- `train.py`: Data preprocessing, training, and model evaluation.
- `predict.py`: Inference script for the saved model.
- `model.pkl`: Serialized trained model.
- `requirements.txt`: Python dependencies.
- `README.md`: Explanation of the algorithm and implementation steps.

## Roadmap

### Week 1: Core ML
- [ ] Linear Regression
- [x] Logistic Regression (Customer Churn)
- [ ] KNN
- [ ] Decision Tree
- [x] Random Forest (Customer Churn)

### Week 2: Intermediate ML
- [ ] SVM
- [ ] Naive Bayes
- [ ] K-Means
- [ ] PCA
